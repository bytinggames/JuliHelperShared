...
namespace JuliHelper.Content
{
    public class ContentBuilder : IDisposable
    {
        ...
        static string[] pipelineAssembliesStock =
        {
            ...
            //
            // CBO: I now add this to a list and use that list instead
        };
        ...
        public ContentBuilder(GraphicsProfile profile)
        {
        ...
        /// <summary>
        /// Set the assemblies to use. I have changed this functionality
        /// to make it easy to add the ModelViewerPipeline assembly.
        /// </summary>
        private void SetAssemblies()
        {
            foreach (string assembly in pipelineAssembliesStock)
            {
                pipelineAssemblies.Add(assembly);
            }

            string appPath = Path.GetDirectoryName(Application.ExecutablePath);
            pipelineAssemblies.Add(appPath + "\\ModelViewerPipeline.dll");
        }
        ...
        public bool Build()
        {
            ...
            // If the build failed, return an error result.
